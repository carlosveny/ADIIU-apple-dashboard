...
function cargarGraficoStock(obj) {
  ...
  //guardar todos los valores maximos/minimos de cada año
  ...
  Highcharts.chart('grafico1', {
    ...
    accessibility: {
      description: 'Gráfica lineal comparando los máximos y mínimos de las acciones de Apple',
      rangeDescription: 'Rango: 2010 a 2020',
      point: {
        valueSuffix: '€'
      }
    }
...
function cargarGraficoStore(objA, objP) {
  ...
  Highcharts.chart('grafico2', {
    ...
    accessibility: {
      description: 'Gráfica de columnas comparando los precios de las aplicaciones en App Store y Play Store',
      rangeDescription: 'Rango: Gratis, 0.01€ - 2€, 2.01€ - 5€, Más de 5€',
      point: {
        valueSuffix: 'Número de aplicaciones'
      }
    }
  });
}
...
function cargarGraficoReviews(obj) {
  ...
  //calcular porcentaje de reviews de cada tipo
  ...
  Highcharts.chart('grafico3', {
    ...
    accessibility: {
      description: 'Gráfica en formato tarta que muestra las valoraciones del iPhone SE',
      rangeDescription: 'Rango: 1 estrella, 2 estrellas, 3 estrellas, 4 estrellas, 5 estrellas',
      point: {
        valueSuffix: 'Número de valoraciones'
      }
    }
  });
}
...
function cargarGraficoMapa(obj) {
  ...
  Highcharts.mapChart('grafico4', {
    ...
    accessibility: {
      description: 'Mapa que muestra los precios del iPhone 11 según el país',
      rangeDescription: 'Rango: 400€ a 800€',
      point: {
        valueSuffix: '€'
      }
    }
